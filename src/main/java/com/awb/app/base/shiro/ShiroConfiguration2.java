...
//    @Bean(name = "myShiroRealm")
    public MyShiroRealm myShiroRealm(@Qualifier("cacheManager") EhCacheManager cacheManager) {
...
//    @Bean
    ...
    /**
     * 加载shiroFilter权限规则（从数据库读取然后配置）
     * @param shiroFilterFactoryBean
     */
    private void loadShiroFilterChain(ShiroFilterFactoryBean shiroFilterFactoryBean, IUserService userService){
        /////////////////////// 下面这些规则配置最好配置到配置文件中 ///////////////////////
...
//    @Bean(name = "shiroFilter")
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager,IUserService userService) {
